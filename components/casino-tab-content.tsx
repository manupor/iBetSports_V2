...
export default function CasinoTabContent({ setIsRegistrationOpen }: CasinoTabContentProps = {}) {
  ...
  const allGames = [
    ...
    },
    {
      ...
      rating: 4.7,
      players: "18.9K",
      description: "Jet-themed crash game",
    },
    {
      id: 27,
      name: "Spaceman",
      ...
      rating: 4.8,
      players: "14.2K",
      description: "Space adventure crash game",
    },
    {
      id: 28,
      name: "Crash X",
      provider: "Turbo Games",
      image: "/images/crash-x.png",
      rtp: "97.0%",
      category: "crash",
      isNew: false,
      isHot: false,
      rating: 4.6,
      players: "9.8K",
      description: "Classic crash game format",
    },
    // Video Poker
    {
      id: 29,
      ...
      provider: "NetEnt",
      image: "/public/jacks-or-better-poker.png",
      rtp: "99.5%",
      category: "poker",
      isNew: false,
      isHot: false,
      rating: 4.7,
      players: "3.2K",
      description: "Classic video poker variant",
    },
    {
      id: 30,
      name: "Deuces Wild",
      provider: "NetEnt",
      image: "/public/deuces-wild-video-poker.png",
      rtp: "99.7%",
      category: "poker",
      isNew: false,
      isHot: false,
      rating: 4.8,
      players: "2.8K",
      description: "Wild card video poker",
    },
    // More Slots
    {
      id: 31,
    ...
    },
    {
      ...
      rating: 4.7,
      players: "16.8K",
      description: "Simple crash game with clean design",
    },
    {
      id: 54,
      name: "Mines",
      ...
      rating: 4.6,
      players: "13.2K",
      description: "Minesweeper style crash game",
    },
    {
      id: 55,
      name: "Plinko",
      provider: "Spribe",
      image: "/images/originals-coinflip.png",
      rtp: "97.0%",
      category: "crash",
      isNew: true,
      isHot: true,
      rating: 4.8,
      players: "19.4K",
      description: "Ball drop probability game",
    },
    {
      id: 56,
      name: "Keno",
    ...
    },
    {
      ...
      name: "Joker Poker",
      provider: "NetEnt",
      image: "/public/joker-poker-video-poker.png",
      rtp: "99.1%",
      category: "poker",
      isNew: false,
      isHot: false,
      rating: 4.6,
      players: "2.4K",
      description: "Video poker with joker wild cards",
    },
    {
      id: 58,
      name: "Aces and Faces",
      provider: "NetEnt",
      image: "/public/aces-faces-video-poker.png",
      rtp: "99.3%",
      category: "poker",
      isNew: false,
      isHot: false,
      rating: 4.7,
      players: "1.9K",
      description: "Video poker with face card bonuses",
    },
    {
      id: 59,
      name: "Bonus Poker",
      provider: "NetEnt",
      image: "/public/bonus-poker-video-poker.png",
      rtp: "99.2%",
      category: "poker",
      isNew: false,
      isHot: false,
      rating: 4.6,
      players: "2.1K",
      description: "Video poker with bonus payouts",
    },
    {
      id: 60,
  ...
  const GameCard = ({ game }: { game: any }) => (
    <Card className="group relative overflow-hidden rounded-xl bg-brand-charcoal-black-secondary border border-brand-primary-green/30 shadow-lg hover:shadow-xl hover:shadow-brand-primary-green/20 transition-all duration-300 cursor-pointer transform hover:scale-105">
      <div className="aspect-[3/4] relative">
        <Image
          src={game.image || "/placeholder.svg?height=300&width=225"}
          alt={game.name}
          fill
