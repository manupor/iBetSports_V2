...
export default function CasinoTabContent({
  ...
  const categories = [
    { id: "all", name: "All Games", count: allGames.length, icon: "🎮" },
    {
      id: "slots",
      name: "Slots",
      count: allGames.filter((g) => g.category === "slots").length,
      icon: "🎰",
    },
    {
      id: "table",
      name: "Table Games",
      count: allGames.filter((g) => g.category === "table").length,
      icon: "🃏",
    },
    {
      id: "live",
      name: "Live Casino",
      count: allGames.filter((g) => g.category === "live").length,
      icon: "🎥",
    },
    {
      id: "jackpot",
      name: "Jackpots",
      count: allGames.filter((g) => g.category === "jackpot").length,
      icon: "💰",
    },
    {
      id: "new",
      name: "New Games",
      count: allGames.filter((g) => g.isNew).length,
      icon: "✨",
    },
    {
      id: "popular",
      name: "Popular",
      count: allGames.filter((g) => g.isHot).length,
      icon: "🔥",
    },
    {
      id: "crash",
      name: "Crash Games",
      count: allGames.filter((g) => g.category === "crash").length,
      icon: "🚀",
    },
    {
      id: "poker",
      name: "Video Poker",
      count: allGames.filter((g) => g.category === "poker").length,
      icon: "♠️",
    },
    {
      id: "bingo",
      name: "Bingo",
      count: allGames.filter((g) => g.category === "bingo").length,
      icon: "🎱",
    },
  ];
    ...
    <Card className="group relative overflow-hidden rounded-xl bg-brand-charcoal-black-secondary border border-brand-primary-green/30 shadow-lg hover:shadow-xl hover:shadow-brand-primary-green/20 transition-all duration-300 cursor-pointer transform hover:scale-105">
      <div className="aspect-[3/4] relative">
        ...
        <div className="absolute top-2 left-2 flex flex-col gap-1">
          {game.isNew && (
            <Badge className="bg-brand-vibrant-green text-brand-charcoal-black text-xs px-2 py-1 font-bold">
              NEW
            </Badge>
          )}
          {game.isHot && (
        ...
        <div className="absolute top-2 right-2">
          <Badge className="bg-black/70 text-brand-soft-white px-2 py-1 text-xs">
            RTP {game.rtp}
          </Badge>
        </div>
        ...
        <div className="absolute inset-0 bg-black/80 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          ...
          <p className="text-brand-primary-green text-xs font-bold mb-2">
            🎁 GET 125% BONUS!
          </p>

          <p className="text-brand-soft-white text-xs text-center px-2">
            {game.description}
          </p>
        </div>
      </div>
      ...
      <div className="p-4">
        <div className="flex items-center justify-between mb-2">
          <h3 className="font-bold text-brand-soft-white text-sm truncate">
            {game.name}
          </h3>
        ...
        <div className="flex items-center justify-between text-xs">
          <Badge
            variant="outline"
            className="text-brand-primary-green border-brand-primary-green"
          >
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row items-center justify-between text-center md:text-left">
            <div className="mb-4 md:mb-0">
              <h3 className="text-xl md:text-2xl font-black text-brand-charcoal-black mb-1">
                🎰 PLAY ANY GAME NOW!
              </h3>
              <p className="text-brand-charcoal-black font-bold">
                Sign up in 30 seconds and get 200% Welcome Bonus + Free Spins!
              </p>
            </div>
            <Button
              onClick={() =>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-6 md:py-8">
        ...
        {filteredGames.length > 0 ? (
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-bold text-brand-soft-white mb-2">
              No games found
            </h3>
