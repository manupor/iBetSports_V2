...
export default function CasinoTabContent() {
  ...
  const featuredGames = [
    {
      ...
      provider: "NetEnt",
      image: "/images/slot-mega-fortune.avif",
      rtp: "96.4%",
      jackpot: "$2,847,392",
      category: "jackpot",
      isNew: false,
  ...
  const slotGames = [
    ...
    },
    {
      ...
      name: "Reactoonz",
      provider: "Play'n GO",
      image: "/images/road-2-riches.png",
      rtp: "96.5%",
      category: "slots",
      isNew: false,
      isHot: true,
  ...
  const tableGames = [
    {
      ...
      provider: "NetEnt",
      image: "/images/european-roulette-table.png",
      rtp: "97.3%",
      category: "table",
      isNew: false,
      isHot: false,
